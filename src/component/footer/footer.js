...
export const Footer = () => (
  <>
    ...
    <footer className="bg-neutral-900 text-center text-white">
      <div className="Footer-container px-6 pt-6 .bg-gray-500">
        <div className="display-flex-footer">

          <div className="online-container-foorter">
            <h2 className="online-media-footer heading-all-component-font-style">
              ONLINE MEDIA CIRCLE
            </h2>
            <div className="footer mb-6">
              <p className="footer-para-text paragrapg-all-component-font-family">
                Since 2016, Team OMC have been dedicated to Nurture authentic, innovative and customized Digital Solutions.
                We look forward to become Customer-Centeric and building a long term relationship, because the team you hire
                is super important – after all, we'll be spending quite a bit of time together. So Whether you are just
                starting out as a one-person operation or an established business seeking to improve your start-up website
                we can offer creative solutions to take your business to the next level .
              </p>
            </div>
          </div>
          ...
          <div className="grid-checking-style">
            <div className="mb-6">
              ...
              <ul className="mb-0 list-none">
                <li>
                  <Link to="/" className="text-white paragrapg-all-component-font-family">
                    Home
                  </Link>
                </li>
                <li>
        ...
        <div className="copyright  flex justify-center">
          <Link to="//www.facebook.com/OMediaCircle/"
          ...
          <Link
            to="//instagram.com/omediacircle?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
            type="button"
            className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
            data-te-ripple-init=""
            data-te-ripple-color="light"
      ...
      <div
        className="p-4 text-center paragrapg-all-component-font-family"
        style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}
      >
        © 2023 Copyright:
        <Link to="/" className="text-cyan paragrapg-all-component-font-family">
          Online media circle
        </Link>
      </div>
    </footer>
